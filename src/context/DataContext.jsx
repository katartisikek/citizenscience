...
export const THEMATIC_CATEGORIES = [
  {
    ...
    title: 'Κλιματική Ανθεκτικότητα, Βιοποικιλότητα & Θαλάσσια Οικοσυστήματα',
    title_en: 'Climate Resilience, Biodiversity & Marine Ecosystems',
    description: 'Παρακολούθηση θαλάσσιας ζωής, παράκτιων ζωνών, δασών και προσαρμογή στην κλιματική αλλαγή στην Κρήτη.',
    icon: '🌊',
    badgeText: 'Κλίμα & Βιοποικιλότητα',
    color: '#0EA5E9',
    bg: '#E0F2FE',
  ...
  {
    id: 'water-soil-food',
    title: 'Νερό, Υγιή Εδάφη & Βιώσιμα Συστήματα Τροφίμων',
    title_en: 'Water, Healthy Soils & Sustainable Food Systems',
    description: 'Ανάλυση ποιότητας υδάτων, υγείας του εδάφους, τοπικής γεωργικής παραγωγής και μεσογειακής διατροφής.',
    icon: '💧',
    badgeText: 'Νερό, Έδαφος & Τρόφιμα',
    color: '#10B981',
    bg: '#D1FAE5',
    image: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?auto=format&fit=crop&q=80&w=800',
  },
  {
    id: 'health-one-health',
    title: 'Υγεία, Πρόληψη & One Health',
    title_en: 'Health, Prevention & One Health',
    description: 'Παρακολούθηση διαβιβαστών (Mosquito Watch), προστασία της δημόσιας υγείας και διασύνδεση ανθρώπου-περιβάλλοντος.',
    icon: '🔬',
    badgeText: 'Υγεία & One Health',
    color: '#6C63FF',
    bg: '#ECE9FF',
    image: 'https://images.unsplash.com/photo-1615814041724-4fec8b74c2e6?auto=format&fit=crop&q=80&w=800',
  },
  {
    id: 'safe-resilient-communities',
    title: 'Ασφαλείς, Ανθεκτικές & Βιώσιμες Κοινότητες',
    title_en: 'Safe, Resilient & Sustainable Communities',
    description: 'Ενδυνάμωση σχολείων, δήμων και τοπικών κοινοτήτων για βιώσιμες, πράσινες και ανθεκτικές πόλεις.',
    icon: '🏛️',
    badgeText: 'Βιώσιμες Κοινότητες',
    color: '#F59E0B',
    bg: '#FEF3C7',
...
const initialProjects = [
  {
    ...
    thematic_category: "health-one-health",
    status: "Ενεργό",
    status_en: "Active",
    image: "https://images.unsplash.com/photo-1615814041724-4fec8b74c2e6?auto=format&fit=crop&q=80&w=800",
  ...
  {
    id: 2,
    title: "Youth4Diagnostics - Νερό & Ποιότητα",
    title_en: "Youth4Diagnostics - Water & Quality",
    thematic_category: "water-soil-food",
    status: "Ολοκληρωμένο",
    status_en: "Completed",
  ...
  {
    id: 3,
    title: "CoastWatch Crete - Παράκτια Οικοσυστήματα",
    title_en: "CoastWatch Crete - Coastal Ecosystems",
    thematic_category: "climate-resilience",
    status: "Ενεργό",
    status_en: "Active",
    image: "https://images.unsplash.com/photo-1518837695005-2083093ee35b?auto=format&fit=crop&q=80&w=800",
    description: "Καταγραφή θαλάσσιας βιοποικιλότητας, παράκτιας διάβρωσης και θαλάσσιων απορριμμάτων στις ακτές της Κρήτης.",
    description_en: "Recording marine biodiversity, coastal erosion and marine litter on the shores of Crete.",
    goal: "Προστασία θαλάσσιων ζωνών",
    goal_en: "Protection of marine zones",
    participants: "Πολίτες & Δύτες",
    participants_en: "Citizens & Divers",
    area: "Παράκτια Κρήτη",
    area_en: "Coastal Crete",
    timeline: "Συνεχές 2026",
    timeline_en: "Ongoing 2026",
    data_types: [...DEFAULT_DATA_TYPES, 'species', 'measurements'],
    form_schema: [
      { name: 'litter_type', label: 'Τύπος απορρίμματος / Είδους', type: 'text' },
    ],
  },
  {
    id: 4,
    title: "Resilient Communities & Eco Schools",
    title_en: "Resilient Communities & Eco Schools",
    thematic_category: "safe-resilient-communities",
    status: "Ενεργό",
    status_en: "Active",
    image: "https://images.unsplash.com/photo-1577495508048-b635879837f1?auto=format&fit=crop&q=80&w=800",
    description: "Δράσεις βιώσιμων πόλεων, χαρτογράφησης αστικού πρασίνου και προσαρμογής τοπικών κοινοτήτων σε ακραία φαινόμενα.",
    description_en: "Sustainable cities initiatives, urban green mapping, and local community adaptation.",
    goal: "Αστική βιωσιμότητα & ανθεκτικότητα",
    goal_en: "Urban sustainability & resilience",
    participants: "Δήμοι & Σχολεία",
    participants_en: "Municipalities & Schools",
    area: "Δήμοι Κρήτης",
    area_en: "Crete Municipalities",
    timeline: "2026 - 2027",
    timeline_en: "2026 - 2027",
    data_types: [...DEFAULT_DATA_TYPES, 'education', 'evaluation'],
    form_schema: [
      { name: 'green_space', label: 'Σημείο Πρασίνου', type: 'text' },
    ],
  },
];
